...
protocol ChangePasscodeScreenDisplayLogic: AnyObject {
}

class ChangePasscodeScreenViewController: UIViewController {
    var interactor: ChangePasscodeScreenBusinessLogic?
    var router: (NSObjectProtocol & ChangePasscodeScreenRoutingLogic & ChangePasscodeScreenDataPassing)?
    ...
    init() {
        ...
        ChangePasscodeScreenConfigurator.sharedInstance.configure(viewController: self)
    }
...
// MARK: - Styles & Layout
extension ChangePasscodeScreenViewController {
    private func setupStyles() {
        ...
        titleLabel.text = "Change Passcode"
...
// MARK: - DisplayLogic
extension ChangePasscodeScreenViewController: ChangePasscodeScreenDisplayLogic { }
