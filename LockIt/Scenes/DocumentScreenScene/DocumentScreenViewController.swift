...
protocol DocumentScreenDisplayLogic: AnyObject {
    func displayCurrentData(viewModel: DocumentScreen.CurrentData.ViewModel)
    func displaySharing(viewModel: DocumentScreen.Share.ViewModel)
}

class DocumentScreenViewController: UIViewController {
    var interactor: DocumentScreenBusinessLogic?
    var router: (NSObjectProtocol & DocumentScreenRoutingLogic & DocumentScreenDataPassing)?
    ...
    init() {
        ...
        DocumentScreenConfigurator.sharedInstance.configure(viewController: self)
    }
...
// MARK: - styles & layout
extension DocumentScreenViewController {
...
// MARK: - DocumentScreenDisplayLogic
extension DocumentScreenViewController: DocumentScreenDisplayLogic {
    func displayCurrentData(viewModel: DocumentScreen.CurrentData.ViewModel) {
...
//                pdfView.document = document
//            } else {
//                print("Ошибка:DocumentScreenViewController  Невозможно создать PDF документ из переданных данных")
//            }
//        }
    }
